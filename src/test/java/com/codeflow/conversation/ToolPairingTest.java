...
class ToolPairingTest {
    ...
    void 落盘记录能还原工具块() {
        ...
        var record = new com.codeflow.session.SessionManager.SessionMessage(
                "assistant", null, "let me check", 0L,
                List.of(new com.codeflow.session.SessionManager.ToolUseRecord("t1", "ReadFile", null)),
                List.of());
        Message restored = com.codeflow.session.SessionManager.toConversationMessage(record);
