...
import com.codeflow.skill.SkillCatalog.Skill;
import com.codeflow.skill.SkillCatalog.SkillMeta;
...
class LoadSkillToolTest {
    ...
    private static final class StubForkHost implements com.codeflow.skill.SkillForkHost {
