...
public class HistoryStore {
    ...
    /** Default constructor &mdash; stores history in {@code ~/.codeflow/prompt_history.jsonl}. */
    public HistoryStore() {
        this(Path.of(System.getProperty("user.home"), ".codeflow", "prompt_history.jsonl"));
    }
