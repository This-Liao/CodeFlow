 ...
 * ({@code ~/.codeflow/skills/}) → project ({@code .codeflow/skills/}),
...
public class SkillCatalog {
    ...
    public String buildSection(String workDir) {
        ...
        var skillsDir = Path.of(workDir, ".codeflow", "skills");
    ...
    public static SkillCatalog loadCatalog(String workDir) {
        ...
        if (home != null) {
            c.loadTier(Path.of(home, ".codeflow", "skills"), "user");
        }

        // Tier 3: project
        c.loadTier(Path.of(workDir, ".codeflow", "skills"), "project");
    ...
    private static List<String> skillDirPaths(String workDir) {
        ...
        String home = System.getProperty("user.home");
        if (home != null) {
            dirs.add(Path.of(home, ".codeflow", "skills").toString());
        }
        if (workDir != null) {
            dirs.add(Path.of(workDir, ".codeflow", "skills").toString());
        }
        return dirs;
    }
