...
public class MemoryConsolidator {
    ...
    public MemoryConsolidator(String workDir, int minHours, int minSessions) {
        ...
        this.memDir = Path.of(workDir, ".codeflow", "memory");
        this.userMemDir = Path.of(System.getProperty("user.home"), ".codeflow", "memory");
    ...
    private void run(LlmClient client, ConversationManager conversation,
        ...
        Path transcriptDir = Path.of(workDir, ".codeflow", "sessions");
