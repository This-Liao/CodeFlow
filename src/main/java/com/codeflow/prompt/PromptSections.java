...
package com.codeflow.prompt;

import com.codeflow.prompt.PromptBuilder.EnvironmentContext;
import com.codeflow.prompt.PromptBuilder.Section;
...
public final class PromptSections {
    ...
    static final String IDENTITY_CONTENT = """
            You are CodeFlow, an AI programming assistant running in the terminal. You help users with \
