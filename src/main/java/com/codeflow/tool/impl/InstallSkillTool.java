...
import com.codeflow.skill.InstallReport;
import com.codeflow.skill.SkillCatalog;
import com.codeflow.skill.SkillInstaller;
import com.codeflow.skill.SkillSource;
...
/**
 * 从 URL 下载并安装 skill 到用户全局目录 (~/.codeflow/skills/)。
 * <p>
...
public class InstallSkillTool implements Tool {
    ...
    private static final String DESCRIPTION =
            ...
            + "(~/.codeflow/skills/). Supports skills.sh URLs (https://www.skills.sh/<owner>/<repo>/<name>), "
    ...
    private String installRoot;   // 为空时自动取 ~/.codeflow/skills
