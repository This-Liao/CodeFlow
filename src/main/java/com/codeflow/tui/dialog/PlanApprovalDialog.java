...
package com.codeflow.tui.dialog;

import com.codeflow.tui.Styles;
import com.codeflow.tui.tea.Style;
import com.codeflow.tui.tea.ANSI256Color;
 ...
 * It is driven by {@code CodeFlowModel}, which calls {@link #handleKey(String)}
 * on every key press and {@link #render()} each frame.
 *
 * @see com.codeflow.tui.CodeFlowModel
 */
public class PlanApprovalDialog {
    ...
    public String render() {
        ...
        sb.append(HEADER_STYLE.render(
                " CodeFlow has written up a plan and is ready to execute. Would you like to proceed?"));
        sb.append("\n\n");
