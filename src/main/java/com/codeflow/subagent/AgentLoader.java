 ...
 *   <li>User-level definitions from {@code ~/.codeflow/agents/*.md}</li>
 *   <li>Project-level definitions from {@code <projectRoot>/.codeflow/agents/*.md}</li>
 * </ol>
...
public final class AgentLoader {
    ...
    public static Map<String, SubAgentSpec> loadAll(Path projectRoot) {
        ...
        if (home != null && !home.isEmpty()) {
            loader.loadDir(Path.of(home, ".codeflow", "agents"));
        }

        if (projectRoot != null) {
            loader.loadDir(projectRoot.resolve(".codeflow").resolve("agents"));
        }
